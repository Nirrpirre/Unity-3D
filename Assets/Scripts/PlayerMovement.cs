...
public class PlayerMovement : MonoBehaviour
{
    ...
    bool jetPackOnCooldown = false;
    int maxJetPackFrames = 400;
    int jetPackFrames = 0;
    ...
    void Update()
    {
        ...
        // Jetpack-logik
        if (Input.GetKey(KeyCode.Q) && jetPackEnabled && !jetPackOnCooldown)
        {
            rb.velocity = new Vector3(rb.velocity.x, 4.5f, rb.velocity.z);
            jetPackFrames++;

            if (jetPackFrames > maxJetPackFrames)
            {
                jetPackFrames = 0;
